...
const slopeValue=v=>Math.max(6,Number.parseFloat(String(v))||24);
const clamp=(v,min,max)=>Math.max(min,Math.min(max,v));
const xFor=f=>42+((Math.log10(clamp(f,20,20000))-Math.log10(20))/(Math.log10(20000)-Math.log10(20)))*696;
