...
from .multi_position_api import async_setup_multi_position_api
...
async def _async_register_frontend(hass: HomeAssistant, entry: ConfigEntry) -> None:
    ...
    await async_register_panel(
        ...
        module_url=f"{STATIC_VERSION_URL}/kcc-soundlab-panel-0632.js?v={VERSION}",
        config={
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if not domain_data.get(WEBSOCKET_REGISTERED):
        ...
        async_setup_multi_position_api(hass)
